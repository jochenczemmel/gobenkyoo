...
func TestAllKanjis(t *testing.T) {
	testCases := []struct {
		...
		{name: "bird", radical: '鳥', want: "嗚塢嫣嬝島嶋嶌搗梟槝樢歍烏瑦窵篶舃蔦螐裊贗鄔鄥隖隝靎靏鰞鳥鳦鳧鳩鳫鳬鳰鳲鳳鳴鳶鳷鳹鴂鴃鴆鴇鴈鴉鴋鴎鴑鴒鴕鴗鴘鴛鴜鴝鴞鴟鴣鴦鴨鴪鴫鴬鴯鴰鴲鴳鴴鴺鴻鴼鴽鴾鴿鵁鵂鵃鵄鵅鵆鵇鵈鵊鵐鵑鵓鵔鵙鵜鵝鵞鵟鵠鵡鵢鵣鵤鵥鵩鵪鵫鵬鵯鵰鵲鵶鵷鵺鵻鵼鵾鶃鶄鶆鶇鶉鶊鶍鶎鶏鶒鶓鶕鶖鶗鶘鶚鶡鶤鶩鶪鶫鶬鶮鶯鶱鶲鶴鶵鶸鶹鶺鶻鶼鶿鷁鷂鷃鷄鷆鷇鷉鷊鷏鷓鷔鷕鷖鷗鷙鷚鷞鷟鷠鷥鷦鷧鷩鷫鷭鷮鷯鷰鷲鷳鷴鷸鷹鷺鷽鷾鸂鸇鸊鸎鸐鸑鸒鸕鸖鸙鸚鸛鸜鸝鸞"},
	}
	for _, c := range testCases {
		t.Run(c.name, func(t *testing.T) {
